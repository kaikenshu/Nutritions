...
def _pantry_call(pantry_id: str, request_type: str, name: str = None, contents: dict = None,
                 return_type: str = DEFAULT_RETURN_TYPE) -> Union[str, dict]:
...
def create_basket(pantry_id: str, name: str, contents: dict, return_type: str = DEFAULT_RETURN_TYPE) -> Union[
    str, dict]:
...
def append_basket(pantry_id: str, name: str, contents: dict, return_type: str = DEFAULT_RETURN_TYPE) -> Union[
    str, dict]:
...
pid = "a7196778-a8d4-4fe2-aec1-9f37293ea35e"
d = {
    "file_str":[",TV,Radio,Newspaper,Sales","1,230.1,37.8,69.2,22.1"]
}
# print(create_basket(pid, "test1",d))
print(get_contents(pid,"test1",return_type="body"))